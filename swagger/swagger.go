...
func v1alphaTrackerTrackerSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "v1alpha/tracker/tracker.swagger.json", size: 17651, mode: os.FileMode(420), modTime: time.Unix(1589002962, 0)}
...
func v1alphaExtractorExtractorSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "v1alpha/extractor/extractor.swagger.json", size: 4592, mode: os.FileMode(420), modTime: time.Unix(1589002962, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func v1alphaSchemaSchemaSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "v1alpha/schema/schema.swagger.json", size: 893, mode: os.FileMode(420), modTime: time.Unix(1589002962, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func v1alphaDepsDepsSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "v1alpha/deps/deps.swagger.json", size: 889, mode: os.FileMode(420), modTime: time.Unix(1589002962, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func v1alphaStoreStoreSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "v1alpha/store/store.swagger.json", size: 2429, mode: os.FileMode(420), modTime: time.Unix(1589002962, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
